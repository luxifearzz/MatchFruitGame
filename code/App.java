...
public class App implements ActionListener {
    ...
    final int PHASE2 = 2;     // timer game = 10 sec, timer hint = 4 sec
    final int PHASE3 = 3;     // timer game = 5 sec, timer hint = 4 sec
    final int PHASE4 = 4;     // timer game = 5 sec, timer hint = 3 sec
    final int WIN_SCORE = 5;

    final int MAX_HEART = 3;
    ...
    private void openCard() {
        ...
        if (score >= PHASE4) timerCounter = 3;
        else if (score >= PHASE2) timerCounter = 4;
        else timerCounter = 5;
    ...
    private void gameTimer() {
        ...
        if (score >= PHASE3) timerCounter = 5;
        else if (score >= PHASE2) timerCounter = 10;
        else timerCounter = 15;
    ...
    private ImageIcon randomFruit() {
        ...
        switch (rnd) {
            case 0 : return PhotoElement.f1;
            case 1 : return PhotoElement.f2;
            case 2 : return PhotoElement.f3;
            case 3 : return PhotoElement.f4;
            case 4 : return PhotoElement.f5;
            case 5 : return PhotoElement.f6;
            case 6 : return PhotoElement.f7;
            case 7 : return PhotoElement.f8;
            case 8 : return PhotoElement.f9;
            case 9 : return randomFruit();
